...
class Gerar_olerite:
    ...
    def _draw_header(self, elements):
        ...
        header = [
            ...
            ["","R   E   C   I   B   O", ""],
            ["", "", ""],
            ["","" * 30, f"VALOR: R$ {valor_sub_total_tres:.2f}"],
            ["", "", ""],
            ["", "", ""],
            ["", "", ""],

            [f"RECEBI DE {empresa_exe} A QUANTIA DE R$: {total_pagamento['sub_total_tres']:.2f}","",""],
        ...
        header_table = Table(header, hAlign='CENTER', colWidths=[250, 100, 150])
