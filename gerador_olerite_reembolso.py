...
class Gerar_olerite_reembolso:
    ...
    def _prepare_content(self, total_pagamento):
        ...
        return [
            ...
            [f"ADICIONAL NOTURNO:", f"{self.funcao.horas_noturnas:.2f}  X  {self.funcao.funcionario_reembolso['adicional_noturno']:.2f}","=", f"R${total_pagamento['pagamento_adicional_noturno']:.2f}"],
            [f"SALDO A RECEBER:","","", f"R${total_pagamento['sub_total_tres']:.2f}"],
    ...
    def _draw_footer(self, elements):
        ...
        cpf_bruto = self.funcao.funcionario_reembolso['numero_cpf']
